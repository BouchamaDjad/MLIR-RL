...
def nn_transform_wrapper_cmd(operation: str) -> str:
...
if __name__ == "__main__":
    models = [
       "./data_utils/tmp_models/MobileNetV2_linalg.mlir",
       "./data_utils/tmp_models/ResNet_linalg.mlir",
       "./data_utils/tmp_models/VGG_linalg.mlir",
       "./data_utils/tmp_models/DenseNet_linalg.mlir"
    ]

    for filename in models:

        model_name = filename.split("/")[-1].split("_")[0]
        out = f"./benchs/{model_name}-bench.mlir"
