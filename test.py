...
# with open('./errors_files/42_operation_6.mlir', 'r') as file:
#     code = file.read()
...
# code = transform_dialect_TP(code,'operation_6',[4,16],op_features.nested_loops,tmp_file)
code = transform_dialect_tile(code,'operation_4',[1],tmp_file)
# code = transform_dialect_interchange(code,'operation_4',[1,0],tmp_file)
 
# code = transform_dialect_fusion(code,'operation_4','operation_3',[2], tmp_file)
...
new_exec_time, bench_passed = evaluate_code_with_cmd_and_timeout(code, tmp_file, 20)
