...
import argparse
from data_utils.generation import LINALG_OPERATION_GENERATORS,BATCH_SIZES,HEIGHTS,CHANNELS,KERNELS,DILATIONS,STRIDES,SIZES,randomSubGraph,softmax
    ...
    for operation_name, (generator, amount) in tqdm(operations_config.items(), desc="linalg operations"):
        ...
        for i in tqdm(range(amount), desc=operation_name):
            ...
            try:
                ...
                if assertion and exec_time is not None:  # exec_time < 1000000:
