...
module attributes {torch.debug_module_name = "Net"} {
  ...
  func.func @matmul() -> tensor<3072x1536xf32> {
    ...
    %6 = call @nanoTime() : () -> i64
    %7 = linalg.matmul {tag = "operation_3"} ins(%1, %3 : tensor<3072x2048xf32>, tensor<2048x1536xf32>) outs(%5 : tensor<3072x1536xf32>) -> tensor<3072x1536xf32>
    %8 = bufferization.alloc_tensor() : tensor<3072x1536xf32>
    %9 = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel"]} ins(%7 : tensor<3072x1536xf32>) outs(%8 : tensor<3072x1536xf32>) attrs =  {tag = "operation_4"} {
    ^bb0(%in: f32, %out: f32):
